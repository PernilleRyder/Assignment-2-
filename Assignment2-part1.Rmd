...
unstd.posterior_R <- likelihood * prior

#Standardize the posterior (so it sums to 1)
posterior_R <- unstd.posterior_R/ sum(unstd.posterior)

#Draw the plot
grid_data_R=data.frame(grid=p_grid,posterior=posterior,prior=prior,likelihood=likelihood)
